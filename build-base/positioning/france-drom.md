...
---
# Positioning a RTK Base station in France and DROM
...
* Download the generated file. Once the window is closed (```close```), the RINEX file will also appear in the logs list with a name like **YYYY-MM-DD-your_mountpoint_name_ign.25o**, with a size of about 4 MB.
...
* In the **"Observation files in RINEX format"** section, upload your file **YYYY-MM-DD-MP.20o** into **Pivot**
...
* Refresh the code with the blue arrows and enter the 4 letters
...
* The report is composed of several sections; the position of your base is located at the end of the document in the **====== RGF93 ======** section
