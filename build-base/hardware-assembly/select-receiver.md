...
## Future receivers
- u-blox X20P module is not usable yet since GLONASS constellation is not supported on current firmware. Other receivers may also be considered, subject to approval on a case-by-case basis. rtkbase is not compatible yet with this receiver.
